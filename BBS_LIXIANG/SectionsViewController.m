...
- (void)viewDidLoad
{
    ...
    RADataObject *food = [RADataObject dataObjectWithName:@"人文信息" children:nil];
    ...
    self.data = [NSArray arrayWithObjects:phone, computer, car, bike, house, motorbike, drinks, food, sweets, watches, walls, nil];
